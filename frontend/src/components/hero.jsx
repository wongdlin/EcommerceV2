  ...
  return (
    <div className="bg-white">
      <header className="absolute inset-x-0 top-0 z-50">
        <nav aria-label="Global" className={`flex items-center justify-between p-6 lg:px-8 ${mobileMenuOpen?"invisible":""}`} >
          <div className="flex lg:flex-1">
            {<Logo/>}
          </div>
          {/* mobile menu button */}
          <NavMenuBtn mobileview={mobileMenuOpen} onBtnClick={setMobileMenuOpen}/>
          {console.log("navmenubtn1",mobileMenuOpen)}
        ...
        <Dialog open={mobileMenuOpen} onClose={setMobileMenuOpen} className="lg:hidden">
          ...
          <NavMenuBtn mobileview={mobileMenuOpen} onBtnClick={setMobileMenuOpen}/>
          {console.log("navmenubtn2",mobileMenuOpen)}
